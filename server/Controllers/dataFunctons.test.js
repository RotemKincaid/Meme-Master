...
describe("newPlayer", () => {
    it("should create a new player object with passed in data", () => {
        var mockData = {username: "francis", avatar: {url: "https//www.someurl.com"}}
        ...
        expect(dataFuncs.newPlayer(mockData).toMatchObject(expected))
    })
    ...
    describe ("shuffleCards", () => {
        it('should shuffle the cards', () => {
            ...
            return dataFuncs.shuffleCards(cardsFromDbTest).then(shuffledCardsTest => {
